...
# Load JSON file
with open('images/similarities_baselineStability_Label.json', 'r') as file:
    data = json.load(file)
...
for model, metrics in data.items():
    ...
    if 'Ref_C' in model: # This is for test the stability of the model
...
#plt.tight_layout()
print(min_max)
plt.savefig('images/similarities_baselineStability_Label.png', dpi=300)
...
fig.suptitle('Baseline performace evaluation')
...
plt.savefig('images/similarities_baselineStability.png', dpi=600)
plt.show() if showFig else None
